...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblPrice.setForeground(new java.awt.Color(51, 0, 102));
        ...
        backButton1.setBackground(new java.awt.Color(51, 0, 102));
        ...
        lblId.setForeground(new java.awt.Color(51, 0, 102));
        lblId.setText("ID:");
        ...
        tblFeatures.setBackground(new java.awt.Color(51, 0, 102));
        tblFeatures.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void btnRemoveFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveFeatureActionPerformed
       ...
       if(selectedRow<0){
           JOptionPane.showConfirmDialog(this, "Please select a row from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
           return;
       }
